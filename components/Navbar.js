        ...
        <div>
            ...
            <nav className={styles.navbar}>
                ...
                <ul className={styles.links}>
                    ...
                    <li><Link href="/login"><button className={styles.login}>Login</button></Link></li> 
                    <li><Link href="/signup"><button className={styles.signup}>Signup</button></Link></li> 
                </ul>
            </nav>
            ...
            {open && (
                <nav ref={menu}>
                    <ul className={styles.menu}>
                        ...
                        <li onClick={() => setOpen(false)}><Link href="/login"><button className={styles.btnMenu}>Login</button></Link></li> 
                        <li onClick={() => setOpen(false)}><Link href="/signup"><button className={styles.btnMenu}>Signup</button></Link></li> 
                    </ul>
                </nav>
            )}
        </div>
